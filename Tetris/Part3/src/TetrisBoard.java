...
public class TetrisBoard {
	...
	public boolean validMove(TetrisPiece piece, int rot, int gridRow, int gridCol){
		if (!OutOfBounds(currentPiece, currentPiece.getPieceRotation(),currentPieceGP[0], currentPieceGP[1]) 
				&&! Collision(currentPiece, currentPiece.getPieceRotation(),currentPieceGP[0], currentPieceGP[1])){
			return true;
		}else {
			return false;
		}
